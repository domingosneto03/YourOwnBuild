...
VALUES
  ...
  ('ryan_smith', 'ryanpass', 'ryan.smith@example.com', 'Ryan Smith', '', 'A product manager', 'Bay Area, San Francisco, CA', false, false),
  ('amanda_clark', 'amandapass', 'amanda.clark@example.com', 'Amanda Clark', '', 'An event planner', 'Bay Area, San Francisco, CA', false, false),
  ('daniel_roberts', 'danielpass', 'daniel.roberts@example.com', 'Daniel Roberts', '', 'A business analyst', 'Bay Area, San Francisco, CA', false, false),
