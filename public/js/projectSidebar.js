document.getElementById("project-tasks-btn").addEventListener("click", function() {
    // Change button colors
    document.getElementById("project-tasks-btn").className = "nav-link active"
    document.getElementById("project-team-btn").className = "nav-link link-body-emphasis"
    document.getElementById("edit-project-btn").className = "nav-link link-body-emphasis"
...
document.getElementById("new-task-btn").addEventListener("click", function() {
    ...
    document.getElementById("project-team-btn").className = "nav-link link-body-emphasis"
    document.getElementById("edit-project-btn").className = "nav-link link-body-emphasis"
    document.getElementById("new-task-btn").className = "nav-link active"
